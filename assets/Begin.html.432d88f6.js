import{_ as e,o as n,c as i,d as s}from"./app.61dcb642.js";const a="/images/新建GoBot项目.png",o="/images/下载依赖01.png",l="/images/依赖下载02.png",d="/images/InitGoBot.png",t="/images/运行截图01.png",c="/images/示例发送成功截图01.png",r={},u=s('<h1 id="开始" tabindex="-1"><a class="header-anchor" href="#开始" aria-hidden="true">#</a> 开始</h1><h2 id="新建项目" tabindex="-1"><a class="header-anchor" href="#新建项目" aria-hidden="true">#</a> 新建项目</h2><blockquote><ol><li>打开goland新建一个项目,(不要选择GOPATH那个选项)</li></ol><p><img src="'+a+`" alt=""></p></blockquote><h2 id="下载依赖" tabindex="-1"><a class="header-anchor" href="#下载依赖" aria-hidden="true">#</a> 下载依赖</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>go get <span class="token string">&quot;github.com/idun886/GoBot&quot;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="`+o+`" alt=""></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>go get <span class="token string">&quot;github.com/idun886/InitGoBot&quot;</span>
